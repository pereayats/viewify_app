...
export default function ErrorDialog({ error, hideDialog }) {
    return (
        <>
            <div
                aria-live="assertive"
                className="pointer-events-none fixed bottom-8 inset-x-0 z-50 flex items-end px-4 py-6 sm:items-start sm:p-6"
            >
