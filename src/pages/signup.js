...
export default function Signup() {
    ...
    const signUp = async (e) => {
		...
		else if (!password || !repeat) setError('Provide a password')
                        ...
                        <div className="border-clip">
                            <form onSubmit={signUp} className="bg-black rounded-3xl border-2 border-teal-300 clip-corner px-6 py-24 sm:px-12 space-y-12">
                                ...
                                <div className="pt-10 text-center text-md font-normal text-neutral-50">
                                    Already have an account? <a href="/login" className="text-teal-300 underline underline-offset-2 decoration-teal-600">Sign up</a>
                                </div>
                            </form>
                        </div>
                    </div>
