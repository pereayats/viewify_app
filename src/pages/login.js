...
export default function Login() {
    ...
    const logIn = async (e) => {
		...
		if (!email || !isEmailValid(email)) setError('Provide a valid email')
		else if (!password) setError('Provide a password')
		else {
			setLoading(true)
			...
			setLoading(false)
			if (data && data.user && data.session) router.replace('/dashboard')
                ...
                <div className="py-12 sm:px-6 lg:px-8">
                    ...
                    <div className="mx-auto w-full max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-2xl">
                        <div className="border-clip">
                            <form onSubmit={logIn} className="bg-black rounded-3xl border-2 border-teal-300 clip-corner px-6 py-24 sm:px-12 space-y-12">
                                ...
                                <div className="flex flex-row items-center gap-x-8 justify-center">
                                    ...
                                    <a href="/reset-password" className="text-center text-md font-normal text-neutral-50 underline underline-offset-2 decoration-neutral-400">
                                        Forgot password?
                                    </a>
                                </div>

                                <div className="pt-10 text-center text-md font-normal text-neutral-50">
                                    Don't have an account? <a href="/signup" className="text-teal-300 underline underline-offset-2 decoration-teal-600">Sign up</a>
                                </div>
                            </form>
                        </div>
                    </div>
